...
- Cloud Run インスタンスの単一性前提などの設計意図: [ADR-058](https://github.com/kenyamaneko/overload-party-common/blob/main/docs/adr/058-gateway-on-cloudrun-single-instance.md)
...
| `turn_timeout_failed` | ターンタイマー期限切れ時 | `true` | タイムアウト負けのバトルサーバーへの登録失敗 |
